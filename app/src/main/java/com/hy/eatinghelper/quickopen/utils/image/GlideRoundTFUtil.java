...
public class GlideRoundTFUtil implements Transformation<Bitmap> {
    ...
    public GlideRoundTFUtil(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public GlideRoundTFUtil(BitmapPool pool, int radius, int margin) {
